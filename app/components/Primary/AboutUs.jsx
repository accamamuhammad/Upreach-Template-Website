...
const AboutUs = () => {
  ...
  return (
    <main className="py-16 space-y-12 flex flex-col items-center justify-center">
      <section className="text-center text-white space-y-2">
        <h1 className="px-5 text-[2.65rem] font-medium">
      ...
      <Video />
      <section className="w-full sm:w-[75%] md:w-[60%] lg:w-[55%] sm:px-5 gap-20 md:gap-16 lg:gap-14 flex flex-col md:flex-row justify-center sm:justify-between items-center text-white">
        {data.map((item, index) => {
          return (
