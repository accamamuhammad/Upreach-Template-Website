      ...
      {!showVideo && (
        <>
          ...
          <button
            ...
            className="z-50 w-[12.5rem] md:w-[13rem] md:text-[1.1rem] absolute bottom-5 left-1/2 -translate-x-1/2 py-3 gap-2 text-[rgb(10,10,10)] flex items-center justify-center bg-[rgb(107,230,129)] rounded-[2rem] font-medium hover:bg-[#5CF28E] transition-colors duration-300"
          >
